{
  ...
  for (int l = 19; l < 24; l++) {
    filenames[l - 13] = template[l].sample + file_end;
  }
  */
  ...
  filenames[10] = template[21].sample + file_end;
  
  
  // this is fubar'ed because i changed the order of the plots. Will need to change order of all plots now
