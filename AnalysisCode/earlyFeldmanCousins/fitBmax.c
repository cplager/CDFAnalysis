void fitBmax()
{
   ...
   cout << endl << endl << "b0 as a function of bMax" << endl;
   ...
   c1->Print("maxb.eps");
   // max vs b
   cout << endl << endl << "bMax as a function of b0" << endl;
   TCanvas c2;
   ...
   c2.Print("bmax.eps");   
   // mean vs b
   cout << endl << endl << "mean as a function of b0" << endl;
   TCanvas c3;
   ...
   // bconst
   cout << endl << endl << "constant term as a function of b0" << endl;
   TCanvas c4;
