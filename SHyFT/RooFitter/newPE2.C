...
void newPE2(double lumi = 0.02, int nPE = 2000, TString systLabel="") {
  ...
  fileName += ".root";
  Fitter::WJetsTemplateInfo *wGenTemplate = new Fitter::WJetsTemplateInfo("WJets",
                                                                          fileName,
                                                                          10068895,31.314,kGreen-3);
  ...
  TString outFileName = "newPE2_met";
  if (systLabel != "") {
    outFileName += "_";
  ...
  if (systLabel == "") {
    std::cout << "**************************************" << std::endl
              ...
              << "** For this kind of PE's, this is   **" << std::endl
              << "** probably what you want.  It      **" << std::endl
              << "** would be strange to do this one  **" << std::endl
              << "** with shifted shapes, but if you  **" << std::endl
              << "** want, you could shift the gen    **" << std::endl
              << "** by setting systLabel to          **" << std::endl
