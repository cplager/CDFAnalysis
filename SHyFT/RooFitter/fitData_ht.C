...
void fitData(double lumi = 0.002961) {
  ...
  //Define the binning
  Fitter::TemplateInfo::setBinning("2j","htLep_2j",20,20,220);
  Fitter::TemplateInfo::setBinning("3j","htLep_3j",10,20,220);
  Fitter::TemplateInfo::setBinning("4j","htLep_[>=4]j",10,20,220);
  ...
  Fitter::plotStack("h_{T,Lep}",templateList,true,"htLep_beforeFit",data);
  Fitter::plotTemplates("h_{T,Lep}", templateList,true,"htLep");
  ...
  Fitter::plotStack("h_{T,Lep}",templateList,true,"htLep_afterFit",data);
