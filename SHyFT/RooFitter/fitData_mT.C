...
void fitData(double lumi = 0.002961) {
  ...
  //Define the binning
  Fitter::TemplateInfo::setBinning("2j","mT_2j",20,0,160);
  Fitter::TemplateInfo::setBinning("3j","mT_3j",10,0,160);
  Fitter::TemplateInfo::setBinning("4j","mT_[>=4]j",10,0,160);
  ...
  Fitter::plotStack("m_{T}",templateList,true,"mT_beforeFit",data);
  Fitter::plotTemplates("m_{T}", templateList,true,"mT");
  ...
  Fitter::plotStack("m_{T}",templateList,true,"mT_afterFit",data);
