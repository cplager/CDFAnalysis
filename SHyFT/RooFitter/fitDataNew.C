...
void fitDataNew(double lumi = 0.002961) {
  
  //Set the luminosity
  Fitter::TemplateInfo::globalInitialization(lumi);

  //Define the binning
  Fitter::TemplateInfo::setBinning("0j","met_0j",35,0,70);
  Fitter::TemplateInfo::setBinning("1j","met_1j",25,0,100);
  Fitter::TemplateInfo::setBinning("2j","met_2j",12,0,120);
  Fitter::TemplateInfo::setBinning("3j","met_3j",10,0,120);
  Fitter::TemplateInfo::setBinning(">=4j","met_[>=4]j",10,0,120);
  ...
  //---W+Jets Template
  Fitter::WJetsTemplateInfo *wTemplate = new Fitter::WJetsTemplateInfo("WJets",
  ...
  RooFitResult *result = fitPDF.fitTo(*dataHist,Minos(true),
                                      ExternalConstraints(RooArgSet(wTemplate->getConstraints(),zTemplate->getConstraints())),
                                      Save());
