...
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_1_1_UVu.root',
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_2_1_jiy.root',
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_3_1_QHM.root',
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_4_1_LMK.root',
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_5_1_Zpr.root',
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_6_1_6bA.root',
'file:/data/ndpc2/c/sboutle/skims_386/ttbar/skim_fullSelection_7_1_Uke.root'
)
)
...
process.outputs = cms.PSet (
    outputName = cms.string('ttbar_test2.root')
)
