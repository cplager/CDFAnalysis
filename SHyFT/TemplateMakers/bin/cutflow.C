...
int eventyield(double lumi, bool isMuon, bool cutSeq) {
  ...
  varInfo *dRlepjj = new varInfo("dRlepjj", "dRlepjj", "delta #sqrt(#phi^2 + #eta^2) between leptonic and hadronic system", 50, 0, 5);
  ...
  // Signal MCs
  sampleInfo *sig130 = new sampleInfo("sig M130","*H(130)*", "anaTree_HWW130", "SQWaT_template_HWW130", 2*14.12*0.0446 , 109986 );
  sampleList.push_back(sig130);
  sigList.push_back(sig130);  

  sampleInfo *sig140 = new sampleInfo("sig M140","*H(140)*", "anaTree_HWW140", "SQWaT_template_HWW140", 2*12.13*0.0737 , 109993 );
  sampleList.push_back(sig140);
  sigList.push_back(sig140);
  
  sampleInfo *sig150 = new sampleInfo("sig M150","*H(150)*", "anaTree_HWW150", "SQWaT_template_HWW150", 2*10.50*0.102 , 109987 );
  sampleList.push_back(sig150);
  sigList.push_back(sig150);
  
  sampleInfo *sig160 = new sampleInfo("sig M160","*H(160)*", "anaTree_HWW160", "SQWaT_template_HWW160", 2*9.08*0.133 , 109990 );
  sampleList.push_back(sig160);
  sigList.push_back(sig160);  

  sampleInfo *sig170 = new sampleInfo("sig M170", "*H(170)*", "anaTree_HWW170", "SQWaT_template_HWW170", 2*7.729*0.141, 109989 );
  sampleList.push_back(sig170);
  sigList.push_back(sig170);  

  sampleInfo *sig180 = new sampleInfo("sig M180","*H(180)*", "anaTree_HWW180", "SQWaT_template_HWW180", 2*6.739*0.137 , 109992 );
  sampleList.push_back(sig180);
  sigList.push_back(sig180);
  
  sampleInfo *sig190 = new sampleInfo("sig M190","*H(190)*", "anaTree_HWW190", "SQWaT_template_HWW180", 2*5.896*0.115 , 109988 );
  sampleList.push_back(sig190);
  sigList.push_back(sig190);  

  sampleInfo *sig250 = new sampleInfo("sig M250","*H(250)*", "anaTree_HWW250", "SQWaT_template_HWW250", 2*3.312*0.103 , 109990 );
  sampleList.push_back(sig250);
  sigList.push_back(sig250);
  
  sampleInfo *sig300 = new sampleInfo("sig M300","*H(300)*", "anaTree_HWW300", "SQWaT_template_HWW300", 2*2.422*0.101 , 106432 );
  sampleList.push_back(sig300);
  sigList.push_back(sig300);  
  twikiList.push_back(sig300);

  sampleInfo *sig350 = new sampleInfo("sig M350","*H(350)*","anaTree_HWW350", "SQWaT_template_HWW350", 2*2.306*0.0990, 109635);
  sampleList.push_back(sig350);
  sigList.push_back(sig350);

  sampleInfo *sig400 = new sampleInfo("sig 400","*H(400)*","anaTree_HWW400", "SQWaT_template_HWW400", 2*2.032*0.0852 , 109991);
  sampleList.push_back(sig400);
  sigList.push_back(sig400);  
  twikiList.push_back(sig400);

  sampleInfo *sig450 = new sampleInfo("sig M450","*H(450)*","anaTree_HWW450", "SQWaT_template_HWW450",  2*1.360*0.0808, 109978);
  sampleList.push_back(sig450);
  sigList.push_back(sig450);

  sampleInfo *sig500 = new sampleInfo("sig M500","*H(500)*","anaTree_HWW500", "SQWaT_template_HWW500", 2*0.849*0.0799, 109982);
  sampleList.push_back(sig500);
  sigList.push_back(sig500);
  twikiList.push_back(sig500);

  sampleInfo *sig550 = new sampleInfo("sig M550","*H(550)*", "anaTree_HWW550", "SQWaT_template_HWW550", 2*0.528*0.0806, 106419);
