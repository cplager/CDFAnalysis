...
process.shyftAnalyzer.selectionDetails.muTrig = cms.string('HLT_IsoMu24_v*')
...
process.shyftAnalyzer.selectionDetails.muonIdTight.RelIso = cms.double(0.1)
...
process.out = cms.OutputModule("PoolOutputModule",
			       ...
			       #fileName = cms.untracked.string("/uscms_data/d2/slaunwhj/scratch0/skim_fullSelection.root"),
                               fileName = cms.untracked.string("ljmet_skim_mu.root") , 
