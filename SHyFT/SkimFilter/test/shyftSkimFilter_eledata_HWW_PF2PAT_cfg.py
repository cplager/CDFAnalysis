...
#process.shyftAnalyzer.selectionDetails.muTrig = cms.string('HLT_IsoMu17_v*')
#process.shyftAnalyzer.selectionDetails.eleTrig = cms.string('HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v2')
...
process.shyftAnalyzer.selectionDetails.jetSrc = cms.InputTag('selectedPatJetsPF')
process.shyftAnalyzer.selectionDetails.muonSrc = cms.InputTag('selectedPatMuonsPF')
process.shyftAnalyzer.selectionDetails.electronSrc = cms.InputTag('selectedPatElectronsPF')
...
fileNames = [
    ...
    'dcap:///pnfs/cms/WAX/11/store/user/lwming/TTJets_TuneZ2_7TeV-madgraph-tauola/SQWaT_elePATtup_42X_ttbar/7327facc0949c2a030127b26734f841e/pat_42x_8_1_iAo.root'
    ]
...
process.out = cms.OutputModule("PoolOutputModule",
			       ...
			       #fileName = cms.untracked.string("/uscms_data/d2/slaunwhj/scratch0/skim_fullSelection.root"),
                               fileName = cms.untracked.string("ljmet_skim_ele.root") , 
